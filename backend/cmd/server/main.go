...
func main() {
	...
	protected.HandleFunc("GET /api/vouchers/{id}", middleware.RBAC("vouchers", vouchers.Detail))
	...
	protected.HandleFunc("GET /api/reports/payables", middleware.RBAC("reports", reports.Payables))
	protected.HandleFunc("GET /api/reports/cash-flow", middleware.RBAC("reports", reports.CashFlow))
	protected.HandleFunc("GET /api/reports/funds-flow", middleware.RBAC("reports", reports.FundsFlow))
	protected.HandleFunc("GET /api/reports/ratio-analysis", middleware.RBAC("reports", reports.RatioAnalysis))
	protected.HandleFunc("GET /api/reports/statistics", middleware.RBAC("reports", reports.Statistics))
	protected.HandleFunc("GET /api/search", middleware.RBAC("dashboard", reports.Search))
